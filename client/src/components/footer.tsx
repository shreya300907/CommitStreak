...
export default function Footer(){
    return(
        <div className="bg-[#060e20] w-full items-center justify-between flex flex-row px-2 sm:px-4 py-4">
            ...
            <div className="font-mono text-primary-text text-xs sm:text-lg">
                Built by Shreya
            </div>
        </div>
    );
